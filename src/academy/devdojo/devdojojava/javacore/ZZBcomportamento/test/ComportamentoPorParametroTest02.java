...
import academy.devdojo.devdojojava.javacore.ZZBcomportamento.interfaces.CarPredicate;
...
//    List<Car> greenCars = filter(ComportamentoPorParametroTest01.cars, new CarPredicate() {
//        @Override
